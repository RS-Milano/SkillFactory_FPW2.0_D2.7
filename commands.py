...
User.objects.create_user('Alice', 'alice@gmail.com', 'alicepassword')

# Создать два объекта модели Author, связанные с пользователями
Author.objects.create(user = User.objects.get(username = 'Bob'))
Author.objects.create(user = User.objects.get(username = 'Alice'))
...
Post.objects.get(id = 1).category.add(Category.objects.get(category = "education"))
